...
public abstract class Hilt_CheckerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CheckerFragment() {
    super();
  }

  Hilt_CheckerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CheckerFragment_GeneratedInjector) this.generatedComponent()).injectCheckerFragment(UnsafeCasts.<CheckerFragment>unsafeCast(this));
    }
  }
