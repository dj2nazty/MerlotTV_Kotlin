...
public abstract class Hilt_AddonSettingsFragment extends PreferenceFragmentCompat implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddonSettingsFragment_GeneratedInjector) this.generatedComponent()).injectAddonSettingsFragment(UnsafeCasts.<AddonSettingsFragment>unsafeCast(this));
    }
  }
