...
public abstract class Hilt_EpgSettingsFragment extends PreferenceFragmentCompat implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EpgSettingsFragment_GeneratedInjector) this.generatedComponent()).injectEpgSettingsFragment(UnsafeCasts.<EpgSettingsFragment>unsafeCast(this));
    }
  }
