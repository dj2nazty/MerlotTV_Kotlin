...
public abstract class Hilt_PlaylistSettingsFragment extends PreferenceFragmentCompat implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PlaylistSettingsFragment_GeneratedInjector) this.generatedComponent()).injectPlaylistSettingsFragment(UnsafeCasts.<PlaylistSettingsFragment>unsafeCast(this));
    }
  }
